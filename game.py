...
class Game(Board):
    ...
    def redraw_window(self, time):
        ...
        # Create hint button
        hint_button = pygame.image.load("images/bulb_icon.png")
        hint_button = pygame.transform.scale(hint_button, (55, 55))
        button_width_hint = hint_button.get_width() + 20
        button_height_hint = hint_button.get_height() + 20

        hint_button_surface = pygame.Surface((button_width_hint, button_height_hint), pygame.SRCALPHA)
        background_button_color_hint = (255, 255, 255)
        pygame.draw.rect(hint_button_surface, background_button_color_hint, (0, 0, button_width_hint, button_height_hint), border_radius=10)

        border_color_hint = (0, 0, 0)
        pygame.draw.rect(hint_button_surface, border_color_hint, (0, 0, button_width_hint, button_height_hint), border_radius=10, width=2)
        
        if (    
            pos[0] > 80 and pos[0] < 80 + button_width_hint and
            pos[1] > 655 and pos[1] < 655 + button_height_hint
        ):
            pygame.draw.rect(hint_button_surface, (76, 175, 80), (0, 0, button_width_hint, button_height_hint), border_radius=10)
        ...
        self.window.blit(hint_button_surface, (80, 655))
        self.window.blit(hint_button, (80 + 10, 655 + 10))
                    ...
                    if (
                        ...
                        try:
                            for index in range(1, 10):
                                if (self.board.insert(index)):
                                    print("Hint", index)
                        except Exception as e:
                            result = messagebox.showinfo("Notifcation", "Please choose square before using hint")
                            if result:
                                print("OK")
